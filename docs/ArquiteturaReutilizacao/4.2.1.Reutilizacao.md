...
<figcaption align='center'>
    <b>Figura 8: prisma.service.ts</b>
...
<figcaption align='center'>
    <b>Figura 9: prisma.service.ts</b>
    <br><small>Fonte: Própria</small>
</figcaption> </center>
...
<figcaption align='center'>
    <b>Figura 10: Criação dos schemas do sistema</b>
...
<figcaption align='center'>
    <b>Figura 13: Serviço do prisma</b>
    <br><small>Fonte: Própria</small>
</figcaption> </center>
...
<figcaption align='center'>
    <b>Figura 14: Logo do framework react.js</b>
...
O [Docke-Compose] (https://docs.docker.com/compose/) é uma ferramenta que permite definir e executar aplicativos multi-contêineres. Ele simplifica a tarefa de gerenciar e orquestrar a execução de vários contêineres Docker como uma única unidade.
![Adapter](docker.jpeg)
