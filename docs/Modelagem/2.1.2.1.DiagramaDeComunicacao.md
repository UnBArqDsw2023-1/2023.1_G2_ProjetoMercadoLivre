# 2.2.1.1 Diagramas Dinâmicos - Diagrama de Comunicação

## Introdução
&emsp;&emsp; De acordo com a notação UML de diagramas dinâmicos, um diagrama de comunicação (também conhecido como diagrama de colaboração) é um tipo de diagrama
...
|  1.1   | Adiciona participantes | Thiago Gomes |    -    | 15/05 |
