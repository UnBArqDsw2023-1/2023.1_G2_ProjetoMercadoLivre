...
![image](https://github.com/UnBArqDsw2023-1/2023.1_G2_ProjetoMercadoLivre/assets/72623771/ce4f7980-a164-4c1d-a54d-14bfad2960d4)
...
No projeto foi utilizao o framework Invesify para aplicação de um padrão de projeto emergente. O inversify é um framework de inversão de controle e injeção de dependência para Javascript/TypeScript. 
...
O inversify é considerado um framework cinza, pois permite a personalização de suas funcionalidade conforme necessário, mas ainda existe uma parte que está encapsulada e fora de controle. 
