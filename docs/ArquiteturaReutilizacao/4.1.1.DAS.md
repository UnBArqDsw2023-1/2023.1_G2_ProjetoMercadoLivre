...
Para o Tamanho e Performace do Sistema é preciso reconhecer as Diferentes formas que um de Scalabilidade de um Sistema de Software.
## 11. Qualidade
...
|  3.1   |     Adicionando início da Visão lógica     |                  João Henrique                  | Gabriel | 01/07 |
|  3.2   |     Refatorando Visão Lógica     |                  João Henrique, Arthur                | Cícero | 01/07 |
